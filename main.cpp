...
//this is the thread for odroid1 which is acting as client for the host station.
 void* odroid1(void* arg1)// receiving thread
 {
...
// this is the thread for odroid2 which is going to recieve data from host station
 void* odroid2(void* arg2)// sender thread
 {
    ifstream infile;
